...
Namespace RobbStrategy
    ...
    Module DebugBacktest
        ...
        Sub Main()
            ...
            ' 
            ' Running this project will perform an EuroStoxx 6 month backtest on the Strategy, using 30 min bars.
            ' 
            ...
            Dim s As RobbStrategy = New RobbStrategy(New Chart(SymbolFactory.GetSymbol("FESX"), BarPeriodType.Minute, 30), Nothing)
